...
export class CreatePlanDto {
  ...
  @ApiProperty({
    ...
    description:
      'ID do preço no Stripe (opcional, será criado automaticamente se não fornecido)',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description:
      'ID do produto no Stripe (opcional, será criado automaticamente se não fornecido)',
    required: false,
  })
  @IsOptional()
