...
export class CreateCheckoutSessionDto {
  ...
  @ApiProperty({
    ...
    description:
      'URL de redirecionamento após pagamento bem-sucedido (OPCIONAL - padrão: APP_URL/subscription/success)',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description:
      'URL de redirecionamento se o usuário cancelar o pagamento (OPCIONAL - padrão: APP_URL/subscription/cancel)',
    required: false,
  })
  @IsOptional()
