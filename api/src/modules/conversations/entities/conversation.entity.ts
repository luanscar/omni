...
class ConversationMessage {
  ...
  @ApiProperty({
    example: 'wamid.HBgLNTU3OTIxMDc1OTIyFQIAERgSNEQ0QzQzRkY5RTIwRjA5OEIzAA==',
  })
  providerId?: string;
...
export class Conversation {
  ...
  @ApiProperty({
    example: 'fa49178f-6595-40b9-a569-3d5c07921234',
    required: false,
  })
  contactId?: string;

  @ApiProperty({
    example: 'fa49178f-6595-40b9-a569-3d5c079288e5',
    required: false,
  })
  channelId?: string;

  @ApiProperty({
    example: 'fa49178f-6595-40b9-a569-3d5c07927777',
    required: false,
  })
  teamId?: string;
  ...
  @ApiProperty({
    ...
    description: 'Array com a última mensagem da conversa',
  })
