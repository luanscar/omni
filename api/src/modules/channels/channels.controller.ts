...
export class ChannelsController {
  ...
  @ApiResponse({ status: 201, description: 'Canal criado com sucesso.', type: Channel })
  ...
  @ApiResponse({ status: 200, description: 'Lista de canais retornada com sucesso.', type: [Channel] })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  findAll(@Request() req) {
  ...
  @ApiResponse({ status: 200, description: 'Canal atualizado com sucesso.', type: Channel })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  @ApiResponse({ status: 404, description: 'Canal não encontrado.' })
